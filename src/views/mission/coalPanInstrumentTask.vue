...
<template>
    <div class="task-performed">
      ...
      <div class="main">
        <el-table :data="state.taskDataList" border style="width: 100%">
          ...
          <el-table-column prop="taskSource" label="任务类型" header-align="center" align="center"></el-table-column>
          <el-table-column prop="taskSource" label="开始执行时间" header-align="center" align="center"></el-table-column>
          <el-table-column prop="taskSource" label="煤棚" header-align="center" align="center"></el-table-column>
        </el-table>
      </div>
    </div>
    <div class="pick-up-plan">
      <div class="header">
        <div class="theme">盘煤仪任务</div>
      ...
      <div class="main">
        ...
        <el-table v-loading="state.dataListLoading" :data="state.dataList" border style="width: 100%">
          ...
          <el-table-column prop="plannedTime"  label="计划时间" header-align="center" align="center"></el-table-column>
          <el-table-column prop="coalShed"  label="煤棚" header-align="center" align="center"></el-table-column>
          <el-table-column label="实际开始/完成时间" header-align="center" align="center">
            <template v-slot="scope">
              <p>{{ scope.row.actualStartTime }}</p>
              <p>{{ scope.row.completionTime }}</p>
            </template>
          </el-table-column>
          <el-table-column label="任务类型" header-align="center" align="center">
            <template v-slot="scope">
              {{ scope.row.taskType ? "通过" : "不通过" }}
            </template>
          </el-table-column>
          <el-table-column label="任务源" header-align="center" align="center">
            <template v-slot="scope">
              {{ scope.row.taskSource ? "通过" : "不通过" }}
            </template>
          </el-table-column>
          ...
          <el-table-column label="操作" fixed="right" header-align="center" align="center" width="180">
            <template v-slot="scope">
              <el-button type="success" size="small" @click="handleApproval(scope.row.id)" style="margin-left: 12px">发布</el-button>
              ...
              <el-button type="danger" size="small" @click="handleApproval(scope.row.id)">终止</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
  ...
  import AddOrUpdate from "./coalPanInstrumentTask-add-or-update.vue";
